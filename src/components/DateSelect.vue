    ...
    <div class="mx-auto w-full max-w-[510px]" ref="datepickerContainerRef">
      <div class="relative mb-3">
        <input
          ...
          class="h-12 w-full appearance-none rounded-lg border border-stroke pl-12 pr-4 text-dark outline-none focus:border-primary dark:border-dark-3-2"
      ...
      <div
        ...
        class="flex w-full flex-col rounded-xl p-4 shadow-four sm:p-[30px]-2"
      >
        <div class="flex items-center justify-between pb-4">
          <button
            id="prevMonth"
            @click="handlePrevMonth"
            class="flex h-[38px] w-[38px] cursor-pointer items-center justify-center rounded-[7px] border-[.5px] border-stroke bg-gray-2 text-dark hover:border-primary hover:bg-primary hover:text-white sm:h-[46px] sm:w-[46px] dark:border-dark-3"
          >
            <svg
              width="24"
              height="24"
          ...
          <span
            id="currentMonth"
            class="text-xl font-medium capitalize text-dark"
          >
            {{
        ...
        >
          ...
          <div
            ...
            :class="{
              'text-dark hover:border-stroke hover:bg-gray-2 dark:hover:border-dark-3 dark:hover:bg-dark':
                day !== null,
...
onMounted(() => {
  // Initial setup only - no document event listeners
});

// Not including any onUnmounted handler for click outside
</script>
